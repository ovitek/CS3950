<h1>Introduction to Computer Science Research, Spring 2022 </h1>
<h2>Tue 9:50am-11:30am, West Village F010	 and/or Zoom</h2>

<p><strong>Instructor:</strong> [Prof. Olga Vitek](http://olga-vitek-lab.ccis.northeastern.edu/)</br>
Email: o.vitek@northeastern.edu</br>
Office hours: After the class, or by appointment. 177 Huntington Ave, 9th floor.</p>

<p><strong>Teaching assistant:</strong></br>
[Mr. Sai Srikanth Lakkimsetty](https://www.linkedin.com/in/sslakkimsetty/), 
Email: lakkimsetty.s@northeastern.edu</br>
Office hours: Fri 12.30pm-1.30pm, or by appointment. 177 Huntington Ave, 9th floor.

<p><strong>Course description:</strong></br>
This 2-credit undergraduate course introduces the scientific method and provides an overview of research in computer science and related fields. Explores recent research advances in these fields, and gives students practice on how to read and analyze scientific literature in different sub-areas. The class will once per week for a 100-minute session. 
...
**Reading and discussing papers or presentations** The majority of the course will consist of summarizing research papers, and prepare presentations for the class.</br> 
**Projects** At the end of the semester, the students will conduct a mini-project, individually or in a small group, overviewing a manuscript of  Khoury faculty member and interviewing the faculty.</br>
...
<p><strong>Course administration:</strong></br> All the discussions and the extra handouts are available on [Piazza](piazza.com/northeastern/spring2022/cs3950/home). Please do not send email.</br> 
...
[Academic integrity policy](http://www.northeastern.edu/osccr/academic-integrity-policy/) is strictly enforced.</br> 
[NEU covid19 safety policy](https://news.northeastern.edu/coronavirus/) is strictly enforced.</br>
Please review [NEU Title IX](https://www.northeastern.edu/ouec/title-ix-policy-2/) policy and procedures.</br>
Please reach out to [Disability Resource Center](www.northeastern.edu/drc) if you need an academic accommodation.
...
Project completion consists of project proposal (25%), manuscript summary (25%), discussion with a faculty member (25%), and leading an in-class precentation and discussion (25%).
...
The final grade is based on a total of 100 points broken down into: 40% attendance and participation, 30% homeworks, 30% project. The final letter grades will follow the usual scale:</br>
